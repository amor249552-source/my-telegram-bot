...
ПРІОРИТЕТ ЗРОСТУ (якщо зріст і вага вказують на різні — обирай за зростом):
- Зріст 180 / вага 65 → M
- Зріст 185 / вага 78 → L
...
Бежевий = кофейний = коричневий — один колір.
Бірюзовий = м'ятний — один колір.
Електрик = синій — уточнюй який саме комплект.
Хакі = зелений — один колір.
Бордовий = червоний — один колір.
...
- Бордовий / Червоний: https://photos.app.goo.gl/FWcdRmCKAhFFKNnu9
...
- Бежевий / Капучіно: https://photos.app.goo.gl/pruYxK5jz3yTi1S17
...
ПІСЛЯ ПІДБОРУ РОЗМІРУ І КОЛЬОРУ — ЗБІР ДАНИХ
