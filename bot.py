...
async def handle_start(update, context):
    if not is_authorized(update.effective_user.id):
        ...
        return
    await update.message.reply_text("👋 Привіт! Я твій AI-асистент для бізнесу. Пиши або надсилай голосові!")
...
async def handle_voice(update, context):
    if not is_authorized(update.effective_user.id):
        return
    await update.message.reply_text("🎤 Голосові повідомлення отримано! Напишіть текстом — голос буде в наступній версії.")
